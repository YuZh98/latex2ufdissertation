...
RULES: dict[str, Rule] = {
    ...
    "UF-S3": Rule(
        "UF-S3", MUST_FIX, SOURCE, "Broken internal cross-references",
        _anchor("UF-S3", "broken-internal-cross-references"),
    ),
    "UF-S4": Rule(
        "UF-S4", REVIEW, PDF, "External URL liveness (deferred)",
        _anchor("UF-S4", "external-url-liveness-deferred"),
    ),
    "UF-S5": Rule(
        "UF-S5", REVIEW, PDF, "Hyperlink annotations clickable in PDF",
        _anchor("UF-S5", "hyperlink-annotations-clickable-in-pdf"),
    ),
    # Doc-class options (D)
    "UF-D1": Rule(
        "UF-D1", REVIEW, SOURCE, "`editMode` option not left on for submission",
    ...
    # Journal-article (J)
    "UF-J1": Rule(
        "UF-J1", REVIEW, SOURCE, "Self-publication first-page footnote (when applicable)",
        _anchor("UF-J1", "self-publication-first-page-footnote-when-applicable"),
    ),
    "UF-J2": Rule(
        "UF-J2", REVIEW, SOURCE, "Co-author acknowledgment (when applicable)",
        _anchor("UF-J2", "co-author-acknowledgment-when-applicable"),
    ),
    # Accessibility (A)
    "UF-A1": Rule("UF-A1", REVIEW, PDF, "PDF tagged structure", _anchor("UF-A1", "pdf-tagged-structure")),
    "UF-A2": Rule(
        "UF-A2", REVIEW, PDF, "Known template accessibility limitations",
