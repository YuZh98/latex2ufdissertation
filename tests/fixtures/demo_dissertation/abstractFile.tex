...
Summer 2026) are out of scope for the initial release. The source-layer
checks are expected to recover the majority of formatting violations
recorded in the Editorial Office's published rejection patterns, with
the PDF layer adding defense-in-depth against template bypass scenarios.
A systematic evaluation on a corpus of public UF dissertations is
